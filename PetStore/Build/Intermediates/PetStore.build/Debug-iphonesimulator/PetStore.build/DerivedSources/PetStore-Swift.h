...
SWIFT_CLASS("_TtC8PetStore21AddPetsViewController")
...
SWIFT_CLASS("_TtC8PetStore25AddingOwnerViewController")
@interface AddingOwnerViewController : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8PetStore11AppDelegate")
...
SWIFT_CLASS("_TtC8PetStore20DetailViewController")
...
@interface Event (SWIFT_EXTENSION(PetStore))
...
SWIFT_CLASS("_TtC8PetStore20MasterViewController")
@interface MasterViewController : UITableViewController <NSFetchedResultsControllerDelegate>
@property (nonatomic, strong) IBOutlet UITableView * _Null_unspecified ownerTableView;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull firstNames;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull lastNames;
...
@property (nonatomic, readonly, strong) PetDatabase * _Nonnull dataRequest;
@property (nonatomic, readonly, copy) NSString * _Nonnull urlString;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull newFName;
- (void)viewDidLoad;
...
- (void)do_table_refreshWithFName:(NSArray * _Nonnull)fName;
- (void)DownloadGetWithGetList:(NSString * _Nonnull)getList;
...
SWIFT_CLASS("_TtC8PetStore11PetDatabase")
@interface PetDatabase : UITableViewCell
- (void)UpLoadPost;
...
SWIFT_CLASS("_TtC8PetStore18PetsViewController")
